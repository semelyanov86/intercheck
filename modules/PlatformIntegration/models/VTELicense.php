...
class PlatformIntegration_VTELicense_Model
{
    public $module = "";
    ...
    public function validate()
    {
        ...
        global $adb;
        $adb->pquery("DELETE FROM `vte_modules` WHERE module=?;", array("VTEQBO"));
        $adb->pquery("INSERT INTO `vte_modules` (`module`, `valid`) VALUES (?, ?);", array("VTEQBO", "0"));
        return false;
    }
