...
use CloudPBX\integration\AbstractNotification;
use CloudPBX\ProvidersEnum;
use CloudPBX\ProvidersErrors;

abstract class ClickToSellNotification extends AbstractNotification {
    ...
    public function validateNotification() {
        $zadarmaSecret = \Settings_CloudPBX_Record_Model::getZadarmaSecret();
