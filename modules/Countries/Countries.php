...
class Countries extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_countries';
	var $table_index= 'countriesid';
	var $related_tables = Array ('vtiger_countriescf' => Array ( 'countriesid', 'vtiger_countries', 'countriesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_countriescf', 'countriesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_countries', 'vtiger_countriescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_countries' => 'countriesid',
		'vtiger_countriescf'=>'countriesid');
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			$this->createRelationship('Transactions', $moduleName, 'Country', 'LBL_TRANSACTION_DETAILS');
			$this->addRelatedList('Transactions', $moduleName, 'Transactions', array('add'));
			$this->createRelationship('Contacts', $moduleName, 'Country');
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_countries, vtiger_users,
                ...
                vtiger_countries.countriesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_countries.countriesid = $id AND
