...
/**
 * Class Countries_Uninstall_View
 */
class Countries_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_countriescf table
        echo "&nbsp;&nbsp;- Delete vtiger_countriescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_countriescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_countries table
        echo "&nbsp;&nbsp;- Delete vtiger_countries table.";
        $result = $adb->pquery("DROP TABLE vtiger_countries");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
