...
/**
 * Class Commissions_Uninstall_View
 */
class Commissions_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_commissionscf table
        echo "&nbsp;&nbsp;- Delete vtiger_commissionscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_commissionscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_commissions table
        echo "&nbsp;&nbsp;- Delete vtiger_commissions table.";
        $result = $adb->pquery("DROP TABLE vtiger_commissions");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
