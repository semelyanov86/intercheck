...
class Commissions extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_commissions';
	var $table_index= 'commissionid';
	var $related_tables = Array ('vtiger_commissionscf' => Array ( 'commissionid', 'vtiger_commissions', 'commissionid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_commissionscf', 'commissionid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_commissions', 'vtiger_commissionscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_commissions' => 'commissionid',
		'vtiger_commissionscf'=>'commissionid');
	...
	var $list_fields = Array (
		...
		'Percent' => Array('commissions', 'percent'),
	...
	var $popup_fields = Array ('percent');

	// For Alphabetical search
	var $def_basicsearch_col = 'percent';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'percent';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('percent','assigned_user_id');

	var $default_order_by = 'percent';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			$this->addRelatedList($moduleName, 'Transactions', 'Commissions', array('add'));
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_commissions, vtiger_users,
                ...
                vtiger_commissions.commissionid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_commissions.commissionid = $id AND
