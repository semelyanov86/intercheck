...
/**
 * Class Commissions_Module_Model
 */
class Commissions_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=Commissions&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );
    ...
    public static function getTotalCommissions($transactionId)
    {
        global $adb;
        ...
        return (float) $adb->query_result($res,0,"percents");
    }
}
