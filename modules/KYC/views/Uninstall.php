...
/**
 * Class KYC_Uninstall_View
 */
class KYC_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_kyccf table
        echo "&nbsp;&nbsp;- Delete vtiger_kyccf table.";
        $result = $adb->pquery("DROP TABLE vtiger_kyccf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_kyc table
        echo "&nbsp;&nbsp;- Delete vtiger_kyc table.";
        $result = $adb->pquery("DROP TABLE vtiger_kyc");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
