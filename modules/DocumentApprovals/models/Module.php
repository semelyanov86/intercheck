...
/**
 * Class DocumentApprovals_Module_Model
 */
class DocumentApprovals_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=DocumentApprovals&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );
    ...
    public function getModuleIcon() {
        ...
        $moduleIcon = "<i class='vicon-assets' title='$title'></i>";
