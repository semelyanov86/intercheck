...
/**
 * Class DocumentApprovals_Uninstall_View
 */
class DocumentApprovals_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_document_approvalscf table
        echo "&nbsp;&nbsp;- Delete vtiger_document_approvalscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_document_approvalscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_document_approvals table
        echo "&nbsp;&nbsp;- Delete vtiger_document_approvals table.";
        $result = $adb->pquery("DROP TABLE vtiger_document_approvals");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
