...
class VDUploadField_Module_Model extends Settings_LayoutEditor_Module_Model
{
    public function getSettingLinks()
    {
        $settingsLinks[] = array('linktype' => 'MODULESETTING', 'linklabel' => 'Settings', 'linkurl' => 'index.php?module=VDUploadField&parent=Settings&view=Settings', 'linkicon' => '');
        $settingsLinks[] = array('linktype' => 'MODULESETTING', 'linklabel' => 'Uninstall', 'linkurl' => 'index.php?module=VDUploadField&parent=Settings&view=Uninstall', 'linkicon' => '');
    ...
    public function getAddSupportedFieldTypes()
    {
        ...
        $ret2 = array_keys(VDUploadField_Constant_Model::$supportedField);
    ...
    public function addField($fieldType, $blockId, $params)
    {
        ...
        $prefix = VDUploadField_Constant_Model::$supportedField[$fieldType]['prefix'];
        ...
        $masseditable = $details['masseditable'];
    ...
    {
        $fieldTypes = array_keys(VDUploadField_Constant_Model::$supportedField);

        if (in_array($fieldType, $fieldTypes)) {
            $uitype = VDUploadField_Constant_Model::$supportedField[$fieldType]['uitype'];
            $uichekdata = 'V~' . $params['mandatory'];
            
            if ($uitype == VDUploadField_Constant_Model::$supportedField['Upload_Field']['uitype']) {
                $type = 'varchar(100)';
            } else {
                $type = 'TEXT';
            }

            return array('uitype' => $uitype, 'typeofdata' => $uichekdata, 'dbType' => $type);
        }
