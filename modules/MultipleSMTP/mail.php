 ...
 */
function send_mail($module, $to_email, $from_name, $from_email, $subject, $contents, $cc = "", $bcc = "", $attachment = "", $emailid = "", $logo = "", $useGivenFromEmailAddress = false, $serverId)
{
    global $adb;
    global $log;
...
/**	Function to set all the Mailer properties
  ...
  */
function setMailerProperties($mail, $subject, $contents, $from_email, $from_name, $to_email, $attachment = "", $emailid = "", $module = "", $logo = "", $serverId)
{
    global $adb;
    ...
    $mail->IsSMTP();
    setMailServerProperties($mail, $serverId);
 ...
 */
function setMailServerProperties($mail, $serverId)
{
    global $adb;
