...
class EMAILMaker_EMAILContentUtils_Model extends Vtiger_Base_Model {
    ...
    public function getUserFieldsForPDF(){
	    return array("username"=>"username","firstname"=>"first_name","lastname"=>"last_name","email"=>"email1","title"=>"title","fax"=>"phone_fax",
    ...
    public function getContactImage($id,$site_url = ""){
        if (isset($id) AND $id != ""){ 
            ...
            if ($num_rows > 0) {
                if ($site_url != "" && substr($site_url, -1) != "/") $site_url .= "/";
    ...
    public function getRelBlockLabels(){
	    return array("Last Modified By" => "Last Modified",
