...
class EMAILMaker_Display_Model extends Vtiger_Base_Model {
            ...
            foreach($conditions as $index => $condition) {
                ...
                if(!empty($columns) && is_array($columns)) {
                    foreach($columns as $column) {
                        ...
                        $wfCondition[] = array('fieldname'=>$fieldname, 'operation'=>$column['comparator'],
    ...
    function isOldContitionFormat($condition) {
    ...
    function getConditionsForDetail($displayed,$conditions,$moduleName) {
