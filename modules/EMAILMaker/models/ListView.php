...
*/
        ...
        $Templates = $EMAILMaker->GetAvailableTemplatesArray($sourceModule, $forListView, $sourceRecord, true);
        ...
        foreach ($Templates AS $row) {
            ...
            foreach ($row as $key => $value) {
                if ($key == "body" || $key == "subtest") $row[$key] = html_entity_decode($value, ENT_QUOTES, $default_charset);
            }
