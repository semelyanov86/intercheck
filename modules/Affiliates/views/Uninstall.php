...
/**
 * Class Affiliates_Uninstall_View
 */
class Affiliates_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_affiliatescf table
        echo "&nbsp;&nbsp;- Delete vtiger_affiliatescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_affiliatescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_affiliates table
        echo "&nbsp;&nbsp;- Delete vtiger_affiliates table.";
        $result = $adb->pquery("DROP TABLE vtiger_affiliates");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
