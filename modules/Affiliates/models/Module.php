...
/**
 * Class Affiliates_Module_Model
 */
class Affiliates_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
       ...
       $settingsLinks[] = array(
           ...
           'linklabel' => 'Uninstall',
           'linkurl' => 'index.php?module=Affiliates&parent=Settings&view=Uninstall',
           'linkicon' => ''
       );
    ...
    public function getModuleIcon() {
        ...
        $moduleIcon = "<i class='vicon-accounts' title='$title'></i>";
