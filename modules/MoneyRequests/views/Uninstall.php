...
/**
 * Class MoneyRequests_Uninstall_View
 */
class MoneyRequests_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_moneyrequestscf table
        echo "&nbsp;&nbsp;- Delete vtiger_moneyrequestscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_moneyrequestscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_moneyrequests table
        echo "&nbsp;&nbsp;- Delete vtiger_moneyrequests table.";
        $result = $adb->pquery("DROP TABLE vtiger_moneyrequests");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
