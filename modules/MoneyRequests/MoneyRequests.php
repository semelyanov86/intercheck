...
class MoneyRequests extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_moneyrequests';
	var $table_index= 'moneyrequestsid';
	var $related_tables = Array ('vtiger_moneyrequestscf' => Array ( 'moneyrequestsid', 'vtiger_moneyrequests', 'moneyrequestsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_moneyrequestscf', 'moneyrequestsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_moneyrequests', 'vtiger_moneyrequestscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_moneyrequests' => 'moneyrequestsid',
		'vtiger_moneyrequestscf'=>'moneyrequestsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_moneyrequests, vtiger_users,
                ...
                vtiger_moneyrequests.moneyrequestsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_moneyrequests.moneyrequestsid = $id AND
