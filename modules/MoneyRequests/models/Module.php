...
/**
 * Class MoneyRequests_Module_Model
 */
class MoneyRequests_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
       ...
       $settingsLinks[] = array(
           ...
           'linklabel' => 'Uninstall',
           'linkurl' => 'index.php?module=MoneyRequests&parent=Settings&view=Uninstall',
           'linkicon' => ''
       );
