...
class Settings_ControlLayoutFields_ListView_Model extends Settings_Vtiger_ListView_Model
{
    /**
    ...
    public function getListViewEntries($pagingModel)
    {
        ...
        for ($i = 0; $i < $noOfRecords; $i++) {
            ...
            $row["execution_condition"] = vtranslate($record->executionConditionAsLabel($row["execution_condition"]), "Settings:ControlLayoutFields");
            $record->setData($row);
