...
class Activities extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_activities';
	var $table_index= 'activitiesid';
	var $related_tables = Array ('vtiger_activitiescf' => Array ( 'activitiesid', 'vtiger_activities', 'activitiesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_activitiescf', 'activitiesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_activities', 'vtiger_activitiescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_activities' => 'activitiesid',
	...
	var $list_fields = Array (
		...
		'Name' => Array('activities', 'name'),
		'Timestamp' => Array('activities', 'timestamp'),
	...
	var $mandatory_fields = Array('name','assigned_user_id', 'timestamp');
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			$this->createRelationship($moduleName, 'Contacts', 'Contact');
			$this->addRelatedList($moduleName, 'Contacts', 'Activities', array('add'));
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_activities, vtiger_users,
                ...
                vtiger_activities.activitiesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_activities.activitiesid = $id AND
    ...
    /**
     * @param $module1 - где создаём
     * @param $module2 - чей создаём
     * @param $fieldLabel - заголовок поля
     */
    public function createRelationship($module1, $module2, $fieldLabel, $block = 'LBL_CUSTOM_INFORMATION')
    {
