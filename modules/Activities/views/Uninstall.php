...
/**
 * Class Activities_Uninstall_View
 */
class Activities_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_activitiescf table
        echo "&nbsp;&nbsp;- Delete vtiger_activitiescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_activitiescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_activities table
        echo "&nbsp;&nbsp;- Delete vtiger_activities table.";
        $result = $adb->pquery("DROP TABLE vtiger_activities");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
