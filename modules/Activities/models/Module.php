...
/**
 * Class Activities_Module_Model
 */
class Activities_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=Activities&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );
    ...
    public function getModuleIcon() {
        ...
        return "<i class='vicon-refresh' title='$title'></i>";
