...
class Alarms extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_alarms';
	var $table_index= 'alarmsid';
	var $related_tables = Array ('vtiger_alarmscf' => Array ( 'alarmsid', 'vtiger_alarms', 'alarmsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_alarmscf', 'alarmsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_alarms', 'vtiger_alarmscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_alarms' => 'alarmsid',
		'vtiger_alarmscf'=>'alarmsid');
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			$this->addRelatedList($moduleName, 'Contacts', 'Alarms', array('add'));
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_alarms, vtiger_users,
                ...
                vtiger_alarms.alarmsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_alarms.alarmsid = $id AND
