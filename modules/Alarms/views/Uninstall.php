...
/**
 * Class Alarms_Uninstall_View
 */
class Alarms_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_alarmscf table
        echo "&nbsp;&nbsp;- Delete vtiger_alarmscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_alarmscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_alarms table
        echo "&nbsp;&nbsp;- Delete vtiger_alarms table.";
        $result = $adb->pquery("DROP TABLE vtiger_alarms");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
