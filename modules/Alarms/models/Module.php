...
/**
 * Class Alarms_Module_Model
 */
class Alarms_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
       ...
       $settingsLinks[] = array(
           ...
           'linklabel' => 'Uninstall',
           'linkurl' => 'index.php?module=Alarms&parent=Settings&view=Uninstall',
           'linkicon' => ''
       );
    ...
    public function getModuleIcon() {
        ...
        $moduleIcon = "<i class='vicon-campaigns' title='$title'></i>";
