...
{strip}
	...
	.module-nav-closed .module-nav .modules-menu {
    width: 42px !important;
    transition: all .5s;
}
.module-nav-expanded .module-nav .modules-menu {
    width: 180px !important;
    transition: all .5s;
}
.module-nav-expanded .listViewContentDiv .listViewEntriesTable {
    margin-left:12% !important;
    width: 84% !important;
    transition: all .5s;
}
.module-nav-closed .listViewContentDiv .listViewEntriesTable {
    margin-left:5% !important;
    transition: all .5s;
}
.module-nav-expanded .row.quotingtool-custommenu {
    margin-left:12% !important;
    width: 84% !important;
    transition: all .5s;
}
.module-nav-closed .row.quotingtool-custommenu {
    margin-left:5% !important;
    transition: all .5s;
}

    </style>
    <div id="modnavigator" class="row module-nav quotingtool-menu" style="height: 12px;">
    ...
    <div class="row quotingtool-custommenu" style="margin-left: 5%;width: 90%">
