                    ...
                    AppUtils.loadTemplate($scope, block.popup_template, true, function (template) {
                        ...
                        AppHelper.showModalWindow(html, '#', function () {
                            ...
                            html.on('click', '.btn-submit', function () {
                                var curId = $rootScope.app.data.signatures;
                                var allowEdit = true;
                                ...
                                if(text == 'Text Field'){
                                    ...
                                    text = '<span class="quoting_tool-draggable-object quoting_tool-widget-signature-container" style="z-index: 1;width: 130px;height: 40px;width: 137px !important;">' +
                                        ...
                                        '<img src="'+$rootScope.app.config.base+'modules/QuotingTool/resources/images/SignHere3.png" title="Signature" alt="" class="quoting_tool-widget-signature-image" data-image-index="signatureImageIndex' + curId + '" style="height: 40px; width: 130px;"> ' +
                                        '</a></span></span></span>';
                                    $rootScope.app.data.signatures++;
                                    ...
                                    text = '<span class="quoting_tool-draggable-object quoting_tool-widget-secondary_signature-container" style="z-index: 2; width: 130px; height: 40px;">' +
                                        ...
                                        '<img src="'+$rootScope.app.config.base+'modules/QuotingTool/resources/images/secondary-signature.png" title="Secondary Signature" alt="" class="quoting_tool-widget-secondary_signature-image" data-image-index="signatureImageIndex' + curId + '" style="height: 40px; width: 130px;">' +
                                        ' </a></span></span></span>';
                                    $rootScope.app.data.signatures++;
                        ...
                        AppHelper.showModalWindow(html, '#', function () {
                            ...
                            html.on('click', '.btn-submit', function () {
                                ...
                                var text = '<span class="quoting_tool-draggable-object quoting_tool-widget-secondary_signature-container" style="z-index: 2; width: 130px; height: 40px;">' +
                                    ...
                                    '<span class="quoting_tool-widget-secondary_signature-main">' +
                                    '<a style="text-decoration: none" data-cke-saved-href="javascript:;" href="javascript:;">' +
                                    '<img src="'+$rootScope.app.config.base+'modules/QuotingTool/resources/images/secondary-signature.png" title="Secondary Signature" data-image-index="signatureImageIndex' + curId + '" alt="" class="quoting_tool-widget-secondary_signature-image" style="height: 40px; width: 130px;">' +
                                    ' </a></span></span></span>';
                                AppUtils.pasteHtmlAtCaret(text);
                                AppHelper.hideModalWindow();
                                $rootScope.app.data.signatures++;
                            ...
                            html.on('click', '.btn-submit', function () {
                                ...
                                for(var icr = 0; icr < totalRows; icr++){
                                    ...
                                    if (rowItem['fieldname'] != 'none'){
                                        var realFieldName = rowItem['fieldname'].split(':')[1];
