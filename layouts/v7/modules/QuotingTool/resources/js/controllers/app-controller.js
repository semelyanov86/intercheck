...
(function ($) {
    ...
    controllers.controller('CtrlApp',
        function ($rootScope, $scope, $templateCache, $compile, $timeout, $translate, PageTitle, AppUtils, AppToolbar, AppConstants,
            ...
            $scope.settings.pricing_table.custom_color = 0;
            $scope.settings.pricing_table.primary_color = '';
            $scope.settings.pricing_table.header_color = '';
            $scope.settings.pricing_table.text_color = '';
            ...
            $scope.settings.related_module.custom_color = 0;
            $scope.settings.related_module.primary_color = '';
            $scope.settings.related_module.header_color = '';
            $scope.settings.related_module.text_color = '';
            ...
            $scope.settings.create_related_record.custom_color = 0;
            $scope.settings.create_related_record.primary_color = '';
            $scope.settings.create_related_record.header_color = '';
            $scope.settings.create_related_record.text_color = '';
                ...
                switch (focus) {
                    ...
                    case $rootScope.app.data.blocks.pricing_table:
                        AppUtils.loadTemplate($scope, focus.setting_template, false, function (html) {
                            ...
                            if (info['settings']) {
                                ...
                                if (info['settings']['custom_color']) {
                                    $scope.settings.pricing_table.custom_color = info['settings']['custom_color'];
                                }
                                if (info['settings']['primary_color']) {
                                    $scope.settings.pricing_table.primary_color = info['settings']['primary_color'];
                                }
                                if (info['settings']['header_color']) {
                                    $scope.settings.pricing_table.header_color = info['settings']['header_color'];
                                }
                                if (info['settings']['text_color']) {
                                    $scope.settings.pricing_table.text_color = info['settings']['text_color'];
                                }
                            ...
                            AppHelper.showModalWindow(html, '#', function () {
                                ...
                                html.on('click', '.btn-submit', function () {
                                    ...
                                    if($scope.settings.pricing_table.custom_color){
                                        if(info.settings.primary_color){
                                            info.settings.theme.settings.thead.style["background-color"] = info.settings.primary_color;
                                        }
                                        if(info.settings.header_color){
                                            info.settings.theme.settings.thead.style["color"] = info.settings.header_color;
                                        }
                                        if(info.settings.text_color){
                                            objTable.find('tbody, tfoot').find('td').css('color',info.settings.text_color);
                                        }
                                    }else{
                                        objTable.find('tbody, tfoot').find('td').css('color','#000000');
                                    }
                    ...
                    case $rootScope.app.data.blocks.pricing_table_idc:
                        AppUtils.loadTemplate($scope, focus.setting_template, false, function (html) {
                            ...
                            $scope.settings.pricing_table.include_section_groups = false;
                            $scope.settings.pricing_table.override_column_configuration = false;
                            $scope.settings.pricing_table.section_groups = '';
                            $scope.settings.pricing_table.style_section_groups = '';
                            $scope.settings.pricing_table.custom_color = 0;
                            $scope.settings.pricing_table.primary_color = '';
                            $scope.settings.pricing_table.header_color = '';
                            $scope.settings.pricing_table.text_color = '';
                            ...
                            if (info['settings']) {
                                ...
                                if (info['settings']['include_section_groups']) {
                                    $scope.settings.pricing_table.include_section_groups = info['settings']['include_section_groups'];
                                }
                                // override_column_configuration
                                if (info['settings']['override_column_configuration']) {
                                    $scope.settings.pricing_table.override_column_configuration = info['settings']['override_column_configuration'];
                                }
                                //Section Groups
                                if (info['settings']['section_groups']) {
                                    $scope.settings.pricing_table.section_groups = info['settings']['section_groups'];
                                }
                                // Include Section Groups
                                if (info['settings']['style_section_groups']) {
                                    $scope.settings.pricing_table.style_section_groups = info['settings']['style_section_groups'];
                                }
                                if (info['settings']['custom_color']) {
                                    $scope.settings.pricing_table.custom_color = info['settings']['custom_color'];
                                }
                            ...
                            AppHelper.showModalWindow(html, '#', function () {
                                ...
                                if (info['settings']) {
                                    ...
                                    $('#settings_pricing_table_section_groups').val($scope.settings.pricing_table.section_groups).trigger('liszt:updated');
                                    $('#settings_pricing_table_section_groups').trigger('change');
                                } else {
                                    // item field
                                    var selectedOptions = $('#settings_pricing_table_fields').find('option:selected');
                                    var rsOrderItem = [];
                                ...
                                html.on('click', '.btn-submit', function () {
                                    ...
                                    for (var i = 0; i < itemFields.length; i++) {
                                        ...
                                        if(selectedItem.label=='#'){
                                            colHeader.unshift(selectedItem.label);
                                            colFieldName.unshift('#');
                                        }else{
                                            colHeader.push(selectedItem.label);
                                            colFieldName.push(selectedItem.name);
                                    ...
                                    for (var thr = 0; thr < theadRows.length; thr++) {
                                        ...
                                        for (var i = 0; i < colHeader.length; i++) {
                                            newTheadCell = firstTheadCell.clone();
                                            newTheadCell.text(colHeader[i]);
                                            newTheadCell.attr('fieldname', colFieldName[i]);
                                            objTheadRow.append(newTheadCell);
                                        }
                                    }
                    ...
                    case $rootScope.app.data.blocks.related_module:
                        AppUtils.loadTemplate($scope, focus.setting_template, false, function (html) {
                            ...
                            if (info['settings']) {
                                ...
                                if (info['settings']['custom_color']) {
                                    $scope.settings.related_module.custom_color = info['settings']['custom_color'];
                                }
                                if (info['settings']['primary_color']) {
                                    $scope.settings.related_module.primary_color = info['settings']['primary_color'];
                                }
                                if (info['settings']['header_color']) {
                                    $scope.settings.related_module.header_color = info['settings']['header_color'];
                                }
                                if (info['settings']['text_color']) {
                                    $scope.settings.related_module.text_color = info['settings']['text_color'];
                                }
                            ...
                            AppHelper.showModalWindow(html, '#', function () {
                                ...
                                html.on('click', '.btn-submit', function () {
                                    ...
                                    if($scope.settings.related_module.custom_color){
                                        if(info.settings.primary_color){
                                            info.settings.theme.settings.thead.style["background-color"] = info.settings.primary_color;
                                        }
                                        if(info.settings.header_color){
                    ...
                    AppUtils.loadTemplate($scope, focus.setting_template, false, function (html) {
                        ...
                        if (info['settings']) {
                            ...
                            if (info['settings']['custom_color']) {
                                $scope.settings.create_related_record.custom_color = info['settings']['custom_color'];
                            }
                            if (info['settings']['primary_color']) {
                                $scope.settings.create_related_record.primary_color = info['settings']['primary_color'];
                            }
                            if (info['settings']['header_color']) {
                                $scope.settings.create_related_record.header_color = info['settings']['header_color'];
                            }
                            if (info['settings']['text_color']) {
                                $scope.settings.create_related_record.text_color = info['settings']['text_color'];
                            }
                        } else {
                            // default
                        ...
                        AppHelper.showModalWindow(html, '#', function () {
                            ...
                            html.on('click', '.btn-submit', function () {
                                ...
                                if($scope.settings.create_related_record.custom_color){
                                    if(info.settings.primary_color){
                                        info.settings.theme.settings.thead.style["background-color"] = info.settings.primary_color;
                                    }
                                    if(info.settings.header_color){
                    ...
                    case $rootScope.app.data.widgets.field_image:
                        AppUtils.loadTemplate($scope, focus.setting_template, true, function (html) {
                            ...
                            AppHelper.showModalWindow(html, '#', function () {
                                if($rootScope.field_image_selected.id){
                                    html.find('#settings_field_image_fields').val($rootScope.field_image_selected.id).select2();
                                }else{
                                    if(html.find('#settings_field_image_fields').find('option[selected="selected"]').length > 0){
                                        if(html.find('#settings_field_image_fields').val() > 0){
                                            html.find('#settings_field_image_fields').find('option:first').attr('selected','selected').closest('select').select2();
                                        }else{
                                            html.find('#settings_field_image_fields').val(html.find('#settings_field_image_fields').find('option:nth-child(2)').val()).select2();
                                        }
                                    }else{
                                        html.find('#settings_field_image_fields').val(html.find('#settings_field_image_fields').find('option:nth-child(2)').val()).select2();
                                    }
            ...
            $rootScope.changeSectionGroups = function ($event) {
                $scope.settings.pricing_table.section_groups = $event.settings.pricing_table.section_groups;
            };
            ...
            $rootScope.loadTemplate = function (templateId) {
                ...
                var container = content.find('.content-container').each(function () {
                    ...
                    html.find('[contenteditable]').each(function () {
                        ...
                        if(thisFocus.is('input') == true || thisFocus.is('span') == true || thisFocus.is('textarea') == true){
                            return;
                        }
                ...
                if (!$rootScope.app.model.id) {
                    ...
                    Template.save({
                        ...
                        if (response.success == true) {
                            ...
                            Template.save({
                                ...
                                check_attach_file: $rootScope.app.model.check_attach_file
                            }, function (response) {
                                if (response.success == true) {
                                } else {
                                    AppHelper.showMessage(response.error.message)
                            ...
                            TemplateSetting.save({
                                ...
                                date_format : $rootScope.app.model.settings.date_format
                            }, function (response) {
                                if (response.success == true) {
                                } else {
                                    AppHelper.showMessage(response.error.message)
                    ...
                    Template.save({
                        ...
                        if (response.success == true) {
                            ...
                            if(idTransaction != '' && idTransaction != undefined){
            ...
            var init = function () {
                ...
                if (!$.isEmptyObject(objSettings)) {
                    ...
                    if(!$rootScope.app.model.settings.enable_decline_mess){
                        $rootScope.app.model.settings.enable_decline_mess = false;
                    }
                    if(!$rootScope.app.model.settings.date_format){
                        $rootScope.app.model.settings.date_format = '';
                    }
                }
                // Body
                ...
                var valCheckAttachFile = $rootScope.app.form_item.check_attach_file.val();
                ...
                $rootScope.app.model.check_attach_file = valCheckAttachFile == "true";
                ...
                if ($rootScope.app.data.selectedModule) {
                    ...
                    $rootScope.listSectionGroups = $rootScope.app.data.selectedModule.section_groups;
                }
