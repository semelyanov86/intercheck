{strip}
    <div class="container-fluid">
         <div class="widget_header row">
            <div class="col-sm-12">
                <h4>{vtranslate('LBL_CLOUD_PBX_SETTINGS', $QUALIFIED_MODULE)}</h4>
            </div>
        </div>
        <hr>
        
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 marginTop15px">
            {assign var=DEFAULT_PROVIDER value=Settings_CloudPBX_Record_Model::getDefaultProvider()}
            <form id="voipEditFrom" class="form-horizontal" data-detail-url="{$MODULE_MODEL->getDetailViewUrl()}">
                <input type="hidden" name="module" value="CloudPBX"/>
