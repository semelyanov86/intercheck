			...
			<table id="listview-table" class="table {if $LISTVIEW_ENTRIES_COUNT eq '0'}listview-table-norecords {/if} listview-table ">
				...
				<tbody class="overflow-y">
					...
					{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
						...
						{assign var=LISTVIEW_ENTRY_TITLE value=Emails_Record_Model::getRestrictedValue($LISTVIEW_HEADER, $LISTVIEW_ENTRY_TITLE, $CURRENT_USER_MODEL)}
						{assign var=LISTVIEW_ENTRY_VALUE value=Emails_Record_Model::getRestrictedValue($LISTVIEW_HEADER, $LISTVIEW_ENTRY_VALUE, $CURRENT_USER_MODEL)}
